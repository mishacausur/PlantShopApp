...
struct PlantModel {
    ...
    static let plants: [PlantModel] = [
        ...
        .init(name: "Swiss Cheese Plant Big Leaf", image: "plant2", price: 60, describing: "It's a Monstera, but a little more fancy, with these beautiful split leaves."),
        ...
        .init(name: "The Chinese Money Plant", image: "plant5", price: 32, describing: "These money plants always look so sweet popped on a window sill or small side table."),
        ...
        .init(name: "Extra Large Strelitzia Plant & Basket", image: "plant7", price: 150, describing: "Big space? Then you'll need some big plants. This beautiful Strelitzia comes in a cool basket that gives it an extra boho touch."),
